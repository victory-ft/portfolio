					...
					<div className="project-container">
						...
						<div className="project-details">
							...
							<div className="project-details-card project-details-two">
								...
								<p className="about-text">
									This personal project is a demonstrative redesign of the
									Kangol e-commerce website, built to showcase my skills in
									modern web development. Leveraging the Next.js framework for
									both frontend rendering and backend API routes, alongside
									MongoDB as the database for managing product data and
									potentially user information, the project demonstrates the
									implementation of a visually updated and functionally improved
									online shopping experience. It serves as a portfolio piece
									highlighting my ability to develop full-stack applications
