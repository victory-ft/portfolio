				...
				<div className="project-container">
					...
					<div className="project-details">
						...
						<div className="project-details-card project-details-two">
							...
							<p className="about-text">
								This project is a dynamic application for exploring movie and TV
								series information, developed using React with TypeScript. It
								utilizes The Movie Database (TMDB) API to fetch comprehensive
								data, allowing users to browse, search for, and view details
								like plot summaries, cast information, ratings, and trailers.
								Built with TypeScript for improved code quality and
								maintainability, this project demonstrates my ability to create
								responsive, data-driven front-end applications and effectively
